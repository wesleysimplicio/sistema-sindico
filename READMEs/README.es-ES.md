...
<p align="center">
  <strong>Sistema de gestión de condominios en PHP 8.2 + MySQL con panel administrativo server-rendered y API REST lista para app móvil.</strong><br />
...
Sistema de gestión de condominios en PHP 8.2 + MySQL con panel administrativo server-rendered y API REST lista para app móvil.
