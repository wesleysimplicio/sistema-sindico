...
<p align="center">
  <strong>Система управления кондоминиумом на PHP 8.2 + MySQL с server-rendered админкой и REST API для мобильного приложения.</strong><br />
...
Система управления кондоминиумом на PHP 8.2 + MySQL с server-rendered админкой и REST API для мобильного приложения.
