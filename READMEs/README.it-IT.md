...
<p align="center">
  <strong>Sistema di gestione condominiale in PHP 8.2 + MySQL con pannello admin server-rendered e REST API pronta per mobile.</strong><br />
...
Sistema di gestione condominiale in PHP 8.2 + MySQL con pannello admin server-rendered e REST API pronta per mobile.
