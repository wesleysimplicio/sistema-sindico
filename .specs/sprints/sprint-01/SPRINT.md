...
Entregar a base de autenticação e o pipeline de CI/CD do sistema-sindico para destravar todas as features futuras de TBD.
...
3. **Deploy automático em staging** — push em `main` dispara deploy para ambiente `staging.sistema-sindico.app` via GitHub Actions.
...
- Domínio `staging.sistema-sindico.app` precisa estar provisionado.
