# CONTRIBUTING — `sistema-sindico`

Guia step-by-step para adicionar uma feature, fix ou refactor em `sistema-sindico` (`TBD`, stack `dotnet`). Funciona pra humano e pra agent. Time: `Wesley Simplicio`.
